...
import com.digitaldart.guardian.area.iam.interfaces.rest.transform.RoleResourceFromEntityAssembler;
...
public class RolesController {
    ...
    public ResponseEntity<List<RoleResource>> getAllRoles() {
        ...
        var roleResources = roles.stream().map(RoleResourceFromEntityAssembler::roleResourceFromEntity).toList();
